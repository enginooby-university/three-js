...
import { FBXModel } from 'models/fbx-models/fbx-model.js'
...
const loadingManager = new THREE.LoadingManager(() => {
    ...
    const pearlDemo: Pearl = pearls[0]
...
function addNewFBXModelToGroupFolder(group: FBXModel[], groupFolder: GUI) {
