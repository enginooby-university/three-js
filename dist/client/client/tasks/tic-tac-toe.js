...
import { MeshLine, MeshLineMaterial } from '../../typings/meshline/meshline.js';
...
function createDatGUI() {
    ...
    barsFolder.add(sceneData.bar, "linewidth", 0, 10).name("width").onFinishChange(value => {
...
function createBars() {
    ...
    line.setPoints(barVectors.vertices);
